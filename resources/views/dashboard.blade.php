        ...
        <div class="content-wrapper">
            ...
            <div class="row" >
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100" style="background-color: rgb(117 178 207) !important;">
                        <div class="card-body">
                            <div class="clearfix">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100" style="background-color: #ffc107a6 !important;">
                        <div class="card-body">
                            <div class="clearfix">
                                <div class="float-left">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100" style="background-color: #28a745!important;">
                        <div class="card-body">
                            <div class="clearfix">
                                <div class="float-left">
